...
source_reader = LinesReader(source_path, max_lines=5_000_000)
target_reader = LinesReader(target_path, max_lines=5_000_000)
...
dataset.downsample(keep_n=200_000, seed=42)
dataset.filter_urls()
dataset.similarity_cutoff(0.9)
